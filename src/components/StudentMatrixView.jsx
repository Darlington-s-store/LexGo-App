...
const StudentMatrixView = () => {
  ...
  const filteredData = matrixData.filter(student => 
            ...
            {sortedData.length > 0 ? (
              sortedData.map((row, idx) => (
                <tr key={idx} className="hover:bg-slate-50/20 transition">
                  ...
                  <td className="p-4 text-center font-semibold text-gray-700">{row.q1}</td>
                  <td className="p-4 text-center font-semibold text-gray-700">{row.q2}</td>
                  <td className="p-4 text-center font-semibold text-gray-700">{row.mid}</td>
                  <td className="p-4 text-center font-semibold text-gray-700">{row.final}</td>
...
export default StudentMatrixView;
