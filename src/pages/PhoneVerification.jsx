...
const PhoneVerification = () => {
  ...
  const handleVerify = (e) => {
    e.preventDefault();
    navigate('/setting-up'); // Redirect to setting-up page after phone verification
  };
    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="w-full md:w-1/2 flex flex-col p-8 sm:p-12 relative min-h-screen justify-between">
        ...
        <div className="w-full max-w-md mx-auto flex flex-col justify-center flex-grow py-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-lexgo-dark text-center mb-4">Phone Number Verification</h2>
          <p className="text-gray-500 text-sm text-center mb-10 max-w-sm mx-auto leading-relaxed">
            Enter the verification code we just sent on your email address +233********67
          </p>
